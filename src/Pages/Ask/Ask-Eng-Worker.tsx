...
const AskEngWorker: React.FC<RequestFormProps> = ({ formType, pathUrl, userToken, onStepChange }) => {
  ...
  useEffect(() => {
    ...
    fetchLookupData()
  }, [formType, pathUrl, userToken,i18n.language])
  ...
  const baseValidationSchema = {
    projectName: Yup.string().required(t('Ask-Eng-Worker.baseValidationSchema.projectName-required')),
    phoneNumber: Yup.string()
      .matches(/^01[0125][0-9]{8}$/, t('Ask-Eng-Worker.baseValidationSchema.phoneNumber-matches'))
      .required(t('Ask-Eng-Worker.baseValidationSchema.phoneNumber-required')),
    projectDescription: Yup.string().required(t('Ask-Eng-Worker.baseValidationSchema.projectDescription.required')),
    unitTypeId: Yup.number().min(1, t('Ask-Eng-Worker.baseValidationSchema.unitTypeId-min')).required(t('Ask-Eng-Worker.baseValidationSchema.unitTypeId-min')),
    budget: Yup.number()
      .typeError(t('Ask-Eng-Worker.baseValidationSchema.budget-typeError'))
      .positive(t('Ask-Eng-Worker.baseValidationSchema.budget-positive'))
      .required(t('Ask-Eng-Worker.baseValidationSchema.budget-required')),
    governorateId: Yup.number().min(1, t('Ask-Eng-Worker.baseValidationSchema.governorateId-min')).required(t('Ask-Eng-Worker.baseValidationSchema.governorateId-min')),
    cityId: Yup.number().min(1, t('Ask-Eng-Worker.baseValidationSchema.cityId-min')).required(t('Ask-Eng-Worker.baseValidationSchema.cityId-min')),
  }

  // Form-specific validation schemas
  const engineerValidationSchema = Yup.object({
    ...baseValidationSchema,
    engineerTypeId: Yup.number().min(1, t('Ask-Eng-Worker.engineerValidationSchema.engineerTypeId-min')).required((t('Ask-Eng-Worker.engineerValidationSchema.engineerTypeId-min'))),
    urgencyLevelId: Yup.number().min(1, t('Ask-Eng-Worker.engineerValidationSchema.urgencyLevelId-min')).required( t('Ask-Eng-Worker.engineerValidationSchema.urgencyLevelId-min')),
    deadline: Yup.string().required( t('Ask-Eng-Worker.engineerValidationSchema.deadline-required')),
  })

  const workerValidationSchema = Yup.object({
    ...baseValidationSchema,
    workerTypeId: Yup.number().min(1,  t('Ask-Eng-Worker.workerValidationSchema.workerTypeId-min')).required( t('Ask-Eng-Worker.workerValidationSchema.workerTypeId-min')),
    materialId: Yup.number().min(1,  t('Ask-Eng-Worker.workerValidationSchema.materialId-min')).required( t('Ask-Eng-Worker.workerValidationSchema.materialId-min')),
  })
  ...
  const renderStep1 = () => (
    <motion.div variants={formVariants} initial="hidden" animate="visible" exit="exit" className="space-y-4">
      <motion.div variants={itemVariants} className="space-y-2">
        <Label htmlFor="projectName">{t('Ask-Eng-Worker.Project-Name')}</Label>
        <Input
          id="projectName"
          name="projectName"
          placeholder={t('Ask-Eng-Worker.Enter-project-name')}
      ...
      {formType === "engineer" ? (
        <motion.div variants={itemVariants} className="space-y-2">
          <Label htmlFor="engineerTypeId">{t('Ask-Eng-Worker.Engineering-Type')}</Label>
          <Select
            name="engineerTypeId"
          ...
          >
            ...
            >
              <SelectValue placeholder={t('Ask-Eng-Worker.Select-engineering-type')}/>
            </SelectTrigger>
            <SelectContent>
        ...
        <motion.div variants={itemVariants} className="space-y-2">
          <Label htmlFor="workerTypeId">{t('Ask-Eng-Worker.Worker-Type')}</Label>
          <Select
            name="workerTypeId"
          ...
          >
            ...
            >
              <SelectValue placeholder={t('Ask-Eng-Worker.Select-worker-type')} />
            </SelectTrigger>
            <SelectContent>
      ...
      <motion.div variants={itemVariants} className="space-y-2">
        <Label htmlFor="unitTypeId">{t('Ask-Eng-Worker.Unit-Type')}</Label>
        <Select
          name="unitTypeId"
        ...
        >
          <SelectTrigger className={formik.touched.unitTypeId && formik.errors.unitTypeId ? "border-red-500" : ""}>
            <SelectValue placeholder={t('Ask-Eng-Worker.Select-unit-type')}/>
          </SelectTrigger>
          <SelectContent>
            {formType === "engineer"
      ...
      <motion.div variants={itemVariants} className="space-y-2">
        <Label htmlFor="projectDescription">{t('Ask-Eng-Worker.Project-Description')}</Label>
        <Textarea
          id="projectDescription"
          name="projectDescription"
          placeholder={t('Ask-Eng-Worker.Enter-project-description')}
      ...
      <motion.div variants={itemVariants} className="space-y-2">
        <Label htmlFor="phoneNumber">{t('Ask-Eng-Worker.Phone-Number')}</Label>
        <Input
          id="phoneNumber"
          name="phoneNumber"
          placeholder={t('Ask-Eng-Worker.Enter-phone-number')}
  ...
  const renderStep2 = () => (
    <motion.div variants={formVariants} initial="hidden" animate="visible" exit="exit" className="space-y-4">
      <motion.div variants={itemVariants} className="space-y-2">
        <Label htmlFor="budget">{t('Ask-Eng-Worker.Budget')}</Label>
        <Input
          id="budget"
          name="budget"
          type="text"
          placeholder={t('Ask-Eng-Worker.Enter-Budget')}
      ...
      <motion.div variants={itemVariants} className="space-y-2">
        <Label htmlFor="governorateId">{t('Ask-Eng-Worker.Governorate')}</Label>
        <Select
          name="governorateId"
          onValueChange={(value) => {
        ...
        >
          ...
          >
            <SelectValue placeholder={t('Ask-Eng-Worker.Select-governorate')} />
          </SelectTrigger>
          <SelectContent>
            {formType === "engineer"
      ...
      <motion.div variants={itemVariants} className="space-y-2">
        <Label htmlFor="cityId">{t('Ask-Eng-Worker.City')}</Label>
        <Select
          name="cityId"
        ...
        >
          <SelectTrigger className={formik.touched.cityId && formik.errors.cityId ? "border-red-500" : ""}>
            <SelectValue placeholder={t('Ask-Eng-Worker.Select-city')}/>
          </SelectTrigger>
          <SelectContent>
            {cities.map((city) => (
      ...
      {formType === "engineer" ? (
        <>
          <motion.div variants={itemVariants} className="space-y-2">
            <Label htmlFor="urgencyLevelId">{t('Ask-Eng-Worker.Urgency-Level')}</Label>
            <Select
              name="urgencyLevelId"
            ...
            >
              ...
              >
                <SelectValue placeholder={t('Ask-Eng-Worker.Select-urgency-level')} />
              </SelectTrigger>
              <SelectContent>
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            <Label htmlFor="deadline">{t('Ask-Eng-Worker.Deadline')}</Label>
            <Popover>
              <PopoverTrigger asChild>
                ...
                >
                  ...
                  {date ? format(date, "PPP") : t('Ask-Eng-Worker.Select-date')}
                </Button>
              </PopoverTrigger>
        ...
        <motion.div variants={itemVariants} className="space-y-2">
          <Label htmlFor="materialId">{t('Ask-Eng-Worker.Material')}</Label>
          <Select
            name="materialId"
          ...
          >
            <SelectTrigger className={formik.touched.materialId && formik.errors.materialId ? "border-red-500" : ""}>
              <SelectValue placeholder={t('Ask-Eng-Worker.Select-material')} />
            </SelectTrigger>
            <SelectContent>
      ...
      <motion.div variants={itemVariants} className="space-y-2">
        <Label>{t('Ask-Eng-Worker.Attach-Photos')}</Label>
        ...
        >
          {isLoading ? (
            <>
              ...
              {t('Ask-Eng-Worker.Submitting...')}
            </>
          ) : (
           t('Ask-Eng-Worker.Submit-btn')
          )}
        </Button>
      </motion.div>
    </motion.div>
