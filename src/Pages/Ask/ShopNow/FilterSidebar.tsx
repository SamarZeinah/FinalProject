        ...
        <div className="space-y-4">
          <div>
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold">{t('ShopNow.MobileFilter.FilterSidebar.PriceRange')}</h3>
              {activeFiltersCount > 0 && (
                ...
                >
                {t('ShopNow.MobileFilter.FilterSidebar.ClearAll')}
                </Button>
              )}
            </div>
            ...
            <div className="space-y-2">
              {/* Price Range */}
                <FilterSection title={t('ShopNow.MobileFilter.FilterSidebar.PriceRange')} >
                <PriceFilter
                  minPrice={minPrice}
                  maxPrice={maxPrice}
              ...
              {/* Colors */}
              <FilterSection title={t('ShopNow.MobileFilter.FilterSidebar.Colors')}>
                <ColorFilter
                  colors={colors}
              ...
              {/* Materials */}
              <FilterSection title={t('ShopNow.MobileFilter.FilterSidebar.Materials')}>
                <MaterialFilter
                  materials={materials}
              ...
              {/* Business Types */}
              <FilterSection title={t('ShopNow.MobileFilter.FilterSidebar.Business-Types')}>
                <BusinessTypeFilter
              ...
              <FilterSection title={t('ShopNow.MobileFilter.FilterSidebar.Business-Type-Categories')}>
