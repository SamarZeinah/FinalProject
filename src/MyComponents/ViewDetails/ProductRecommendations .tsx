          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex justify-between items-center w-full">
              ...
              <span className="text-lg text-gray-700">
                {t('ProductRecommendations.EGP')} <span className="font-bold">{Seller.price}</span>{" "}
              </span>
            </div>
          </div>
        </div>
        <h2 className="font-bold text-lg">{t('ProductRecommendations.SELLER')} </h2>
          ...
          <div className="border border-gray-300 rounded-lg overflow-hidden">
            ...
            <div className="flex items-center justify-between px-3 py-5 cursor-pointer">
              ...
              <span className="text-sm text-gray-800 font-medium flex-grow ml-4">
                {t('ProductRecommendations.Sold-by')}{Seller.seller}
                <br />
                ...
                <span className="font-bold">
                  {" "}
                  ({Seller.ratingPercentage}% {t('ProductRecommendations.Positive-Rating')})
                </span>
              </span>
            ...
            <div className="bg-gray-50 px-4 py-5 grid grid-cols-2 gap-y-6 gap-x-4">
              <div className="flex items-center space-x-2">
                ...
                {t('ProductRecommendations.Partner-Since')}
                </span>
              </div>
              <div className="flex items-center space-x-2">
                <PercentCircle className="text-yellow-600 w-5 h-5" />
                <span className="text-sm text-gray-700 font-bold">
                  {t('ProductRecommendations.Item-Described')}
                </span>
              </div>
              <div className="flex items-center space-x-2">
                <Clock3 className="text-blue-600 w-5 h-5" />
                <span className="text-sm text-gray-700 font-bold">
                  {t('ProductRecommendations.Great-Recent-Rating')}
                </span>
              </div>
              <div className="flex items-center space-x-2">
                <RotateCcw className="text-red-600 w-5 h-5" />
                <span className="text-sm text-gray-700 font-bold">
                {t('ProductRecommendations.Low-Return-Seller')}
                </span>
              </div>
            </div>
          </div>
        ...
        <Link to="/combined-section" className="block">
          <div className="border border-gray-300 rounded-lg overflow-hidden">
            ...
            <div className="flex items-center justify-between px-3 py-5 cursor-pointer">
              ...
              <span className="text-sm text-gray-800 font-medium flex-grow ml-4">
                {t('ProductRecommendations.Free-delivery')}
              </span>
             { i18n.dir() === "rtl" ? (
              <ChevronLeft className="w-4 h-4 text-gray-500" />
            ) : (
            ...
            <div className="flex items-center justify-between px-3 py-5 cursor-pointer">
              ...
              <span className="text-sm text-gray-800 font-medium flex-grow ml-4">
              {t('ProductRecommendations.This-item')}
              </span>
              { i18n.dir() === "rtl" ? (
                  <ChevronLeft className="w-4 h-4 text-gray-500" />
                ) : (
