      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              {t("ProductFilterPanel.Reset-all")}
            </motion.button>
            <motion.button
        ...
        <AnimatePresence>
          {filters.colorsIds?.length || filters.businessTypeIds?.length ? (
            ...
            >
              <h3 className="text-sm font-medium text-gray-900 mb-3">{t("ProductFilterPanel.Active-Filters")}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <h3 className="text-sm font-medium text-gray-900 mb-4 flex items-center gap-2">
              ...
              {t("ProductFilterPanel.Price-Range")}
            </h3>
            <div className="flex gap-2 items-center">
              <div className="relative w-full">
                <input
                  type="number"
                  placeholder={t("ProductFilterPanel.Min")}
              ...
              <div className="relative w-full">
                <input
                  type="number"
                  placeholder={t("ProductFilterPanel.Max")}
          ...
          >
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {!filters.colorsIds?.length && <div className="text-sm text-gray-500">{t("ProductFilterPanel.Select-colors")}</div>}
              </div>
            </div>
                ...
                >
                  <div className="p-3 border-b border-gray-100">
                    <div className="relative">
                      <input
                        type="text"
                        placeholder={t("ProductFilterPanel.Search-colors")}
                  ...
                  <div className="max-h-60 overflow-y-auto p-2">
                    {filteredColors.length === 0 ? (
                      <div className="text-center py-4 text-gray-500">{t("ProductFilterPanel.No-colors")}</div>
                    ) : (
            ...
            >
              <h3 className="text-sm font-medium text-gray-900 mb-4 flex items-center justify-between">
                <span className="flex items-center gap-2">
                  ...
                  {t("ProductFilterPanel.Categories")}
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {!filters.businessTypeIds?.length && <div className="text-sm text-gray-500">{t("ProductFilterPanel.Select-categories")}
                </div>}
              </div>
            </div>
                ...
                >
                  <div className="p-3 border-b border-gray-100">
                    <div className="relative">
                      <input
                        type="text"
                        placeholder={t("ProductFilterPanel.Search-categories")}
                  ...
                  <div className="max-h-60 overflow-y-auto p-2">
                    {filteredCategories.length === 0 ? (
                      <div className="text-center py-4 text-gray-500">{t("ProductFilterPanel.No-categories")}</div>
                    ) : (
