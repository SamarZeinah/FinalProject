...
export default function DimensionsSection({
  ...
  return (
    <div className="space-y-2">
      <Label>{t("DimensionsSection.Dimensions")}</Label>
      <div className="grid grid-cols-3 gap-4">
        <div className="space-y-2">
          <Input
            id="length"
            name="length"
            placeholder={t("DimensionsSection.Length")}
            type="text"
        ...
        <div className="space-y-2">
          <Input
            id="width"
            name="width"
            placeholder={t("DimensionsSection.Width")}
            type="text"
        ...
        <div className="space-y-2">
          <Input
            id="height"
            name="height"
            placeholder={t("DimensionsSection.Height")}
            type="text"
