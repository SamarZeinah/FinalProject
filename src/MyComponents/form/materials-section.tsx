...
export default function MaterialsSection({ materials, addMaterial, removeMaterial }: MaterialsSectionProps) {
  ...
  const handleAddMaterial = () => {
    ...
    if (materials.includes(selectedMaterial)) {
      setMaterialError(`"${getMaterialDisplayName(selectedMaterial)}" ${t("materials-section.has-added")}`)
      return
    }
  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="material">{t("materials-section.Materials")}</Label>
      <div className="flex gap-2">
        <div className="relative flex-1">
          ...
          >
            ...
            >
              <SelectValue placeholder={t("materials-section.Materials")} />
            </SelectTrigger>
            <SelectContent>
      ...
      {materials.length > 0 && (
        <div className="pt-2">
          <p className="text-sm font-medium text-gray-500 mb-3">{t("materials-section.Selected-Materials")}</p>
