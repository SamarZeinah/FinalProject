  ...
  if (isLoadingConfig) {
    return (
      <div className="container mx-auto px-4 py-8">
        <LoadingSpinner message= {t('ShopNow.MobileFilter.FilterSidebar.Loading-configuration...')} />
      </div>
    );
  }
        ...
        <div className="flex items-center justify-between mb-8 animate-in fade-in slide-in-from-top-4 duration-700">
          <div>
            <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent">
              {t('ShopNow.Header.Products')}
            </h1>
            <p className="text-muted-foreground animate-in slide-in-from-left-2 duration-500 text-lg">
               {t('ShopNow.Header.Showing')} {products.length}  {t('ShopNow.Header.Products')}
            </p>
          </div>
          ...
          <Sheet>
            <SheetTrigger asChild>
              ...
              >
                ...
                {t('ShopNow.MobileFilter.Filters')}
            ...
            <SheetContent side="left" className="w-80 p-0 flex flex-col">
              <SheetHeader className="p-6 pb-4 border-b">
                ...
                <SheetDescription>
                  {t('ShopNow.MobileFilter.Filter-products-criteria')}
                </SheetDescription>
              </SheetHeader>
          ...
          <div className="flex-1 min-h-[600px]">
            ...
            <div className="relative min-h-[500px]">
              ...
              {(isFiltering || isLoadingProducts) && (
                <LoadingSpinner message={t('ShopNow.MobileFilter.FilterSidebar.Loading-products...')} isOverlay />
              )}
