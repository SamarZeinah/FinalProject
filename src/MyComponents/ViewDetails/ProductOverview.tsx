...
const ProductOverview = ({ description, highlights, specifications }: ProductOverviewProps) => {
  ...
  return (
    <div className="bg-white border border-gray-200 shadow-md rounded-lg px-6 pb-[80px] pt-[20px]">
      <h1 className="text-2xl font-bold text-gray-800 border-b pb-2 mb-6">{t('ProductOverview.Product-Overview')}</h1>
      ...
      <div className="flex flex-col md:flex-row gap-x-7">
        ...
        <div className="w-full md:w-1/2 space-y-7">
          {/* Highlights */}
          <div>
            <h3 className="text-lg font-semibold text-gray-700 mb-2">{t('ProductOverview.Highlights')}</h3>
          ...
          {/* Overview */}
          <div>
            <h3 className="text-lg font-semibold text-gray-700 mb-2">{t('ProductOverview.Overview')}</h3>
        ...
        <div className="w-full md:w-1/2 border-t md:border-t-0 md:border-l border-gray-200 pt-7 md:pt-0 md:pl-7">
          <h3 className="text-lg font-semibold text-gray-700 mb-2">{t('ProductOverview.Specifications')}</h3>
