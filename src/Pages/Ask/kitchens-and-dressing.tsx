...
const KitchensAndDressing: React.FC<KitchensAndDressingProps> = ({
  ...
  const validationSchema = Yup.object({
    phoneNumber: Yup.string()
      .matches(/^01[0125][0-9]{8}$/, t('Kitchen-Dressing.validationSchema.phoneNumber-matches'))
      .required(t('Kitchen-Dressing.validationSchema.phoneNumber-required')),

    governorateId: Yup.number()
      .min(1, t('Kitchen-Dressing.validationSchema.governorateId-min'))
      .required(t('Kitchen-Dressing.validationSchema.governorateId-mins')),

    budget: Yup.number()
      .typeError(t('Kitchen-Dressing.validationSchema.budget-typeError'))
      .positive(t('Kitchen-Dressing.validationSchema.budget-positive'))
      .required(t('Kitchen-Dressing.validationSchema.budget-required')),

    requiredDuration: Yup.number()
      .typeError(t('Kitchen-Dressing.validationSchema.requiredDuration-typeError'))
      .positive(t('Kitchen-Dressing.validationSchema.requiredDuration-positive'))
      .required(t('Kitchen-Dressing.validationSchema.requiredDuration-required')),
    ...(formType === "kitchen" && {
      kitchenSize: Yup.number()
      .typeError(t('Kitchen-Dressing.validationSchema.kitchenSize-typeError'))
      .positive(t('Kitchen-Dressing.validationSchema.kitchenSize-positive'))
      .required(t('Kitchen-Dressing.validationSchema.kitchenSize-required')),

      kitchenTypeId: Yup.number()
        .min(1, t('Kitchen-Dressing.validationSchema.kitchenTypeId-min'))
        .required(t('Kitchen-Dressing.validationSchema.kitchenTypeId-min')),
      ...
      devicesAttacheds: Yup.array()
        ...
        .min(1, t('Kitchen-Dressing.validationSchema.devicesAttacheds-min'))
        .required(t('Kitchen-Dressing.validationSchema.kitchenTypeId-required')),
    }),
    productMaterial: Yup.array()
      ...
      .min(1, t('Kitchen-Dressing.validationSchema.productMaterial-min'))
      .required(t('Kitchen-Dressing.validationSchema.productMaterial-required')),
            ...
            {currentStep === 1 && (
              <>
                ...
                <motion.div variants={itemVariants} className="space-y-2">
                  <Label htmlFor="phoneNumber">{t('Kitchen-Dressing.Phone-Number')}</Label>
                  <Input
                    id="phoneNumber"
                    name="phoneNumber"
                    placeholder={t('Kitchen-Dressing.Enter-phone-number')}
                ...
                {/* governorate */}
                <motion.div variants={itemVariants} className="space-y-2">
                  <Label htmlFor="governorateId"> {t('Kitchen-Dressing.Governorate')}</Label>
                  <Select
                    name="governorateId"
                    onValueChange={(value) => {
                  ...
                  >
                    ...
                    >
                      <SelectValue placeholder={t('Kitchen-Dressing.Select-Governorate')} />
                    </SelectTrigger>
                    <SelectContent>
                ...
                {formType === "kitchen" && (
                  <motion.div variants={itemVariants} className="space-y-2">
                    <Label htmlFor="kitchenTypeId">{t('Kitchen-Dressing.Kitchen-Types')}</Label>
                    <Select
                      name="kitchenTypeId"
                      onValueChange={(value) => {
                    ...
                    >
                      ...
                      >
                        <SelectValue placeholder={t('Kitchen-Dressing.Select-kitchen-Type')}/>
                      </SelectTrigger>
                      <SelectContent>
                ...
                {formType === "kitchen" &&
                  (KitchenData?.devicesAttacheds?.length ?? 0) > 0 && (
                    <div className="grid gap-2">
                      <Label htmlFor="devicesAttacheds">{t('Kitchen-Dressing.Devices-Attached')}</Label>
                ...
                {formType === "kitchen" && (
                  <motion.div variants={itemVariants} className="space-y-2">
                    <Label htmlFor="kitchenSize">{t('Kitchen-Dressing.Kitchen Size')}</Label>
                    <Input
                      id="kitchenSize"
                      placeholder={t('Kitchen-Dressing.Enter-kitchen-size')}
                      name="kitchenSize"
                      type="number"
            ...
            {currentStep === 2 && (
              <>
                ...
                {(KitchenData?.productMaterial?.length ?? 0) > 0 && (
                  <div className="grid gap-2">
                    <Label htmlFor="productMaterial">{t('Kitchen-Dressing.Product-Material')}</Label>
                ...
                {/* Budget */}
                <motion.div variants={itemVariants} className="space-y-2">
                  <Label htmlFor="budget">{t('Kitchen-Dressing.Budget')}</Label>
                  <Input
                    id="budget"
                    placeholder={t('Kitchen-Dressing.Enter-Budget')}
                    name="budget"
                    type="number"
                ...
                {/* Required Duration */}
                <motion.div variants={itemVariants} className="space-y-2">
                  <Label htmlFor="requiredDuration">{t('Kitchen-Dressing.Required-Duration')}</Label>
                  <Input
                    id="requiredDuration"
                    placeholder={t('Kitchen-Dressing.Required-Duration')}
                ...
                {/* Notes */}
                <motion.div variants={itemVariants} className="space-y-2">
                  <Label htmlFor="notes">{t('Kitchen-Dressing.Notes')}</Label>
                  <Input
                    id="notes"
                    placeholder={t('Kitchen-Dressing.Notes')}
                    name="notes"
                    type="text"
                ...
                <motion.div variants={itemVariants} className="space-y-2">
                  <Label>{t('Kitchen-Dressing.Attach-Photos')}</Label>
                  ...
                  >
                    {isLoading ? (
                      <>
                        ...
                        {t('Kitchen-Dressing.Submitting..."')}
                      </>
                    ) : (
                      t('Kitchen-Dressing.Submit-btn')
                    )}
                  </Button>
                </motion.div>
              </>
