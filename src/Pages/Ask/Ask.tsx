...
export default function Ask() {
  ...
  const getBackgroundImage = () => {
    ...
    const getTitle = () => {
    if (formType === "engineer") return t('Ask.Ask-Engineer');
    if (formType === "worker") return t('Ask.Ask-Worker');
    if (formType === "request-design") return t('Ask.Request-Design');
    if (formType === "home-renovate") return t('Ask.Renovate-Home');
    if (formType === "furnish-house") return t('Ask.Furnish-Home');
    if (formType === "kitchen" || formType === "dressing")
      return t('Ask.Kitchen-Dressing');
    return "";
  };
