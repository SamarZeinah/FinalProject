...
const{t}=useTranslation();
  return (
    <Card className="bg-white shadow-md p-4 w-full max-w-full mx-auto">
      <h1 className="text-2xl font-bold text-gray-800 border-b pb-2 mb-6">{t('ProductFeatures.Product-Features')}</h1>
      <div
      ...
      <CardContent className="text-center mt-4">
        <Button  onClick={() => setExpanded(!expanded)}>{expanded ? t('ProductFeatures.Show-Less') : t('ProductFeatures.View-full-Product-Features')}</Button>
      </CardContent>
    </Card>
  )
}
