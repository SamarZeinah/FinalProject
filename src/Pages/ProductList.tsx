...
const colors = data?.colors || []
  ...
  const loadProducts = useCallback(async (page: number, filterState: FilterState, search: string) => {
    ...
    try {
      ...
      const response: IProductsResponse = await fetchProducts(page, 9, filterCriteria, search,i18n.language)
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex-1 max-w-xl">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder={t("ProductHeader.Search-products")}
                    value={searchQuery}
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {error && (
            <Alert variant="destructive" className="mb-6">
              ...
              <AlertTitle>{t("ProductList.Error")}</AlertTitle>
          ...
          {isUsingMockData && (
            <Alert className="mb-6 bg-blue-50 border-blue-200">
              ...
              <AlertTitle className="text-blue-700">{t("ProductList.Development-Mod")}</AlertTitle>
              <AlertDescription className="text-blue-600">
              {t("ProductList.AlertDescription")}
              </AlertDescription>
            </Alert>
          )}
                ...
                >
                  {products?.length > 0 ? (
                    ...
                    <div className="col-span-3 text-center py-12">
                      <p className="text-gray-500 text-lg">{t("ProductList.No-products-matching")}</p>
                    </div>
                  )}
                </motion.div>
              </AnimatePresence>
